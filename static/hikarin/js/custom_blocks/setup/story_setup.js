...
export const generator = (block, pythonGenerator) => {
  ...
  const setupCode = pythonGenerator.statementToCode(block, 'SETUP_STACK');

  // Get the code generated by blocks connected to the "STORY_STACK" input.
  // This will be all the 'say', 'show', 'label', etc. blocks.
  const storyCode = pythonGenerator.statementToCode(block, 'STORY_STACK');
